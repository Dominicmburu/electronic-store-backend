...
CREATE TABLE "Settings" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "newsSubscription" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "Category" ADD CONSTRAINT "Category_printerTypeId_fkey" FOREIGN KEY ("printerTypeId") REFERENCES "PrinterType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
